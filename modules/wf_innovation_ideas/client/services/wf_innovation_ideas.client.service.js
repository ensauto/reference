(function () {
  ...
  angular
    ...
    .factory('WF_Innovation_IdeasService', WF_Innovation_IdeasService);

  WF_Innovation_IdeasService.$inject = ['$resource'];

  function WF_Innovation_IdeasService($resource) {
    var WF_Innovation_Idea = $resource('api/wf_innovation_ideas/:wf_innovation_ideaId', {
