(function () {
  ...
  angular
    ...
    .factory('MyWF_Abnormal_IncidentsService', MyWF_Abnormal_IncidentsService);

  MyWF_Abnormal_IncidentsService.$inject = ['$resource'];

  function MyWF_Abnormal_IncidentsService($resource) {
    var WF_Abnormal_Incident = $resource('api/my_wf_abnormal_incidents/:wf_abnormal_incidentId', {
