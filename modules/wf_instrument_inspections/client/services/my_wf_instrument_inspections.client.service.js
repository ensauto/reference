(function () {
  ...
  angular
    ...
    .factory('MyWF_Instrument_InspectionsService', MyWF_Instrument_InspectionsService);

  MyWF_Instrument_InspectionsService.$inject = ['$resource'];

  function MyWF_Instrument_InspectionsService($resource) {
    var WF_Instrument_Inspection = $resource('api/my_wf_instrument_inspections/:wf_instrument_inspectionId', {
